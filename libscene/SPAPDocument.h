...
public:
	...
	BOOL SaveToFile();
	_bstr_t GetDocXml();
	int GetDocXmlLen() const;
	void GetDocXml(char* pXml, int bufLen);
...
public:
	...
	BOOL SetCDATASectionData(MSXML2::IXMLDOMNodePtr nodeDest, LPCTSTR cszText);
...
public:
	...
	_bstr_t GetCDATASectionData(MSXML2::IXMLDOMNodePtr nodeFrom);
